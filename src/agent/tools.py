...
def _build_filter(section_filter: dict | None, version: Version | None) -> dict | None:
...
@tool
def search_units(query: str, version: Version | None = None) -> str:
...
@tool
def search_leaders(query: str, version: Version | None = None) -> str:
...
@tool
def search_great_people(query: str, version: Version | None = None) -> str:
...
@tool
def search_techs_and_civics(query: str, version: Version | None = None) -> str:
...
@tool
def search_buildings_and_improvements(query: str, version: Version | None = None) -> str:
...
@tool
def search_general(query: str, version: Version | None = None) -> str:
